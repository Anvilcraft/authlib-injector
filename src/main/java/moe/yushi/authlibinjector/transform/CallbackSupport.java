...
final class CallbackSupport {
    ...
    private static final String METAFACTORY_SIGNATURE
        = "(Ljava/lang/invoke/MethodHandles$Lookup;Ljava/lang/String;Ljava/lang/invoke/"
          + "MethodType;Ljava/lang/String;)Ljava/lang/invoke/CallSite;";
    ...
    static void callWithInvokeDynamic(
        MethodVisitor mv, Class<?> owner, String methodName, TransformContext ctx
    ) {
        String descriptor
            = Type.getMethodDescriptor(findCallbackMethod(owner, methodName));
        ...
        mv.visitInvokeDynamicInsn(
            methodName, descriptor, callbackMetafactory, owner.getName()
        );
    }

    static void callWithIntermediateMethod(
        MethodVisitor mv0, Class<?> owner, String methodName, TransformContext ctx
    ) {
        Method callbackMethod = findCallbackMethod(owner, methodName);
        String descriptor = Type.getMethodDescriptor(callbackMethod);
        String intermediateMethod = "__authlibinjector_intermediate__"
            + owner.getName().replace('.', '_') + "__" + methodName;
        mv0.visitMethodInsn(
            INVOKESTATIC,
            ctx.getClassName().replace('.', '/'),
            intermediateMethod,
        ...
        ctx.addGeneratedMethod(intermediateMethod, cv -> {
            ...
            mv.visitMethodInsn(
                ...
                "findStatic",
                "(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/invoke/MethodType;)Ljava/"
            ...
            if (returnType == void.class) {
                mv.visitInsn(RETURN);
                       ...
                       || returnType == char.class || returnType == short.class
