...
public class MC52974_1710Workaround {
    ...
    public static void init() {
        MainArgumentsTransformer.getVersionSeriesListeners().add(version -> {
            if ("1.7.10".equals(version)) {
                ...
                AuthlibInjector.getClassTransformer().units.add(
                    new S0CPacketSpawnPlayerTransformer()
                );
                AuthlibInjector.retransformClasses(
                    "bbs",
    ...
    private static final Map<Object, Optional<Object>> markedGameProfiles
    ...
    accessGameProfile(Object gp, Object minecraftServer, boolean isNotchName) {
        synchronized (markedGameProfiles) {
            ...
            if (value != null) {
                ...
                if (minecraftServer != null) {
                    ...
                    try {
                        ...
                        Class<?> classGameProfile
                            = cl.loadClass("com.mojang.authlib.GameProfile");
                        Object gameProfile
                            = classGameProfile.getConstructor(UUID.class, String.class)
                                  .newInstance(
                                      classGameProfile.getMethod("getId").invoke(gp),
                                      classGameProfile.getMethod("getName").invoke(gp)
                                  );

                        Class<?> classMinecraftServer
                            = cl.loadClass("net.minecraft.server.MinecraftServer");
    ...
    private static class SessionTransformer implements TransformUnit {
        ...
        public Optional<ClassVisitor> transform(
            ...
            return detectNotchName(
                className,
                "bbs",
                "net.minecraft.util.Session",
                isNotchName -> new ClassVisitor(ASM9, writer) {
                    @Override
                    public MethodVisitor visitMethod(
                        ...
                        if (isNotchName ? "e".equals(name)
                                    && "()Lcom/mojang/authlib/GameProfile;".equals(
                                        descriptor
                                    )
                                        : "func_148256_e".equals(name)
                                    && "()Lcom/mojang/authlib/GameProfile;".equals(
                                        descriptor
                                    )) {
                ...
                isNotchName -> new ClassVisitor(ASM9, writer) {
                    ...
                    public MethodVisitor visitMethod(
                        ...
                        if (isNotchName
                                ...
                                : "func_148840_b".equals(name)
                                    && "(Lnet/minecraft/network/PacketBuffer;)V".equals(
                                        descriptor
                                    )) {
                            return new MethodVisitor(
                                ASM9,
                                ...
                                public void visitFieldInsn(
                                    ...
                                    if (opcode == GETFIELD
                                        && (isNotchName
                                                ? "gb".equals(owner) && "b".equals(name)
                                                    && ("Lcom/mojang/authlib/"
                                                        + "GameProfile;").equals(
                                                           descriptor
                                                       )
                                                : ("net/minecraft/network/play/server/"
                                                   + "S0CPacketSpawnPlayer").equals(owner)
                                                    && "field_148955_b".equals(name)
                                                    && ("Lcom/mojang/authlib/"
                                                        + "GameProfile;").equals(
                                                           descriptor
                                                       ))) {
                                        ...
                                        super.visitTypeInsn(
                                            CHECKCAST, "com/mojang/authlib/GameProfile"
                                        );
                                    }
                                }
                            };
    ...
    private static <T> Optional<T> detectNotchName(
        String input, String ifNotchName, String ifDeobf, Function<Boolean, T> callback
    ) {
