 ...
 * BungeeCord allows only certain characters to occur in the username when online-mode is
 * on.
 */
        ...
        if ("net.md_5.bungee.util.AllowedCharacters".equals(className)) {
            return Optional.of(new ClassVisitor(ASM9, writer) {
                ...
                public MethodVisitor visitMethod(
                    ...
                    if ("isValidName".equals(name)
                        && "(Ljava/lang/String;Z)Z".equals(descriptor)) {
