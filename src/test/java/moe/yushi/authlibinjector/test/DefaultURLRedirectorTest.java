...
public class DefaultURLRedirectorTest {
    ...
    private DefaultURLRedirector redirector = new DefaultURLRedirector(
        new APIMetadata(apiRoot, emptyList(), emptyMap(), Optional.empty())
    );
    ...
    public void testReplace() {
        testTransform(
            // from:
            // [com.mojang:authlib:1.5.24]/com.mojang.authlib.yggdrasil.YggdrasilGameProfileRepository
            "api.mojang.com",
            "/profiles/",
        ...
        testTransform(
            // from:
            // [com.mojang:authlib:1.5.24]/com.mojang.authlib.yggdrasil.YggdrasilMinecraftSessionService
        ...
        testTransform(
            // from:
            // [com.mojang:authlib:1.5.24]/com.mojang.authlib.yggdrasil.YggdrasilUserAuthentication
        ...
        testTransform(
            ...
            // issue: yushijinhun/authlib-injector#7
            // <https://github.com/yushijinhun/authlib-injector/issues/7>
            "skins.minecraft.net",
        ...
        testTransform(
            // from:
            // [bungeecord@806a6dfacaadb7538860889f8a50612bb496a2d3]/net.md_5.bungee.connection.InitialHandler
            // url:
            // https://github.com/SpigotMC/BungeeCord/blob/806a6dfacaadb7538860889f8a50612bb496a2d3/proxy/src/main/java/net/md_5/bungee/connection/InitialHandler.java#L409
            "sessionserver.mojang.com",
            "/session/minecraft/hasJoined?username=",
            "https://yggdrasil.example.com/sessionserver/session/minecraft/"
            + "hasJoined?username="
        );
        ...
        testTransform(
            ...
            // issue: yushijinhun/authlib-injector#6
            // <https://github.com/yushijinhun/authlib-injector/issues/6>
            "api.mojang.com",
